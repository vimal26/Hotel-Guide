...
public class Cypresshotel  extends Four3 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.cypresshotel);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.cypbed);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.cypbeda);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.cypdi);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.cyph);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.cypha);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.hotelbookingadvisor.com/Hotel/Cypress_Hotel_Pune.htm"));
        startActivity(i);
        break;
