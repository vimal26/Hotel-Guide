...
public class Grandsolitare extends Four7 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.gsf);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.gsinter);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.gsroom);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.gssit);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.gswath);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.thegrandsolitairehotel "));
        startActivity(i);
        break;
