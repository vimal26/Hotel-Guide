...
public class Tulip extends Three6 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.tulipb);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.tulipbed);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.tuliphall);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.tulipmeetng);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.tuliprecep);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.tripadvisor.in/Hotel_Review-g297684-d1673806-Reviews-Tulip_Inn_Lucknow-Lucknow_Uttar_Pradesh.html "));
        startActivity(i);
        break;
