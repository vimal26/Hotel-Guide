...
public class Samarajodhpur extends Five10 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.samfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.samdr);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.samriver);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.samroom);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.samshl);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.samsarapalace.com"));
        startActivity(i);
        break;
