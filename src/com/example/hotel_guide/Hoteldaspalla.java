...
public class Hoteldaspalla extends Four7 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.hddinn);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.hddt);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.hdfr);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.hdhall);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.hdroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.hoteldaspallahyderabad"));
        startActivity(i);
        break;
