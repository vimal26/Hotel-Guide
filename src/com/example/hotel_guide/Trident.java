...
public class Trident extends Five5 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.trident);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.tridentjaibad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.tridentjaide);

		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.tridentjaidinn);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.tridentjaifr);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.tridentjaipool);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.tridentjaipur.com"));
        startActivity(i);
        break;
