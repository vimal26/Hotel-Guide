...
public class Chancescasinogoa extends Five9 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView3:
		im1.setImageResource(R.drawable.chanluxery);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.chanroom);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.changym);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.chancescasinoandresort.com"));
        startActivity(i);
        break;
