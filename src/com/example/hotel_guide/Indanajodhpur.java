...
public class Indanajodhpur extends Five10 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.indfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.indexteriorw);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.indlobby);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.indrestaurant);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.indroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.indanapalace.com"));
        startActivity(i);
        break;
