...
public class Wyandhamagra extends Five8 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.wyandhamagra);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.wynexterior);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.wynhall);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.wynhotel);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.wynlobby);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.wynroom);
		break;
	case R.id.tv:
