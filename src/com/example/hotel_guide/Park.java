...
public class Park extends Five7 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.pkdinn);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.pkfr);
        break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.pkpool);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.pkroom);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.pksitt);break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.theparkhyderabad.com"));
        startActivity(i);
        break;
