...
public class Square extends Four7 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.sqbad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.sqdinn);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.sqdt);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.sqfr);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.sqkit);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.thesquredyderabad"));
        startActivity(i);
        break;
