...
public class Hotelhoward  extends Five10 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.hotelhowardplaza);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.howardfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.howardenterance);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.howardcraft);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.howardresturent);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.howardroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.hotelhowardplaza.com"));
        startActivity(i);
        break;
