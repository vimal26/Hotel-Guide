...
public class Starhotel extends Five2 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.starhotel);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.starbe);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.starbed);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.stardin);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.stargue);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.starguest);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.hotelbookingadvisor.com/Hotel/Sahara_Star_Hotel.htms"));
        startActivity(i);
        break;
