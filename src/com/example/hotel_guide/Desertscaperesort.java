...
public class Desertscaperesort  extends Three10 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.desertscaperesort);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.desertfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.desertbhj);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.desertroom);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.desertrooom);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.desertspa);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.desertscaperesort.com"));
        startActivity(i);
        break;
