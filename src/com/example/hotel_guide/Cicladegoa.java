...
public class Cicladegoa extends Five9 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.cicladegoa);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.cidappool);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.cidaresturent);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.cidaresturenta);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.cidaroom);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.cidasuite);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.wyndhamgrandagra.com"));
        startActivity(i);
        break;
