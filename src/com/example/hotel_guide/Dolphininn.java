...
public class Dolphininn extends Three8 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.dolphininn);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.dolpfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.dolprare);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.dolpkit);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.dolptable);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.dolproom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.dolphininn.com"));
        startActivity(i);
        break;
