...
public class umaidjodhpur extends Five10 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.umaidfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.umaidext);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.umaidhall);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.umaidlift);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.umaidroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.umaidbhawanpalace.com"));
        startActivity(i);
        break;
