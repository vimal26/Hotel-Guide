...
public class Adamothebeius extends Three9 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.adamothebeius);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.amadfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.amaddhe);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.amadrest);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.amadrest);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.amadroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.adamothebeiius.com"));
        startActivity(i);
        break;
