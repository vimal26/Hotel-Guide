...
public class Meradanvaranasi extends Four_Star implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.meradanvaranasi);
...
public void onClick(View arg0) {
	...
	case R.id.tv:
        ...
        i.setData(Uri.parse("http://http://meradengrand.com/home.html"));
        startActivity(i);
        break;
