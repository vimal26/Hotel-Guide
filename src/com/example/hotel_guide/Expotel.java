...
public class Expotel extends Four7 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.exbad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.exdinn);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.exdlx);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.exfr);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.exhall);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.expotelhotel "));
        startActivity(i);
        break;
