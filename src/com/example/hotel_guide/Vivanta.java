...
public class Vivanta extends Five6 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
    		setContentView(R.layout.vivanta);
...
public void onClick(View arg0) {
	...
	case R.id.tv:
        ...
        i.setData(Uri.parse(" http://www.booking.com/hotel/in/taj-residency-lucknow.en-gb.html?aid=332539;label=gcad-74715_site-hotelfinder_ucc-IN_ulang-en_ucurr-INR_ver-false;sid=ec10f009ad4e5f5769999762aca84f62;dcid=1;checkin=2013-08-18;checkout=2013-08-19;srfid=7247ac6e200f46f571f10a1279194bfbe956512aX1"));
        startActivity(i);
        break;
