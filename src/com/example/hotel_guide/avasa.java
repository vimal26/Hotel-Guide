...
public class avasa extends Five7 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.avasa);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.aw);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.avbad);

		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.avdinn);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.avfr);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.avpool);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.avasahotel.com"));
        startActivity(i);
        break;
