...
public class Crystalretreat extends Three8 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.crystalretreat);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.crysfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.cryscolidor);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.cryshall);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.crysreception);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.crysroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.crystalretreat.com"));
        startActivity(i);
        break;
