...
public class velra extends Four5 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.vestrabad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.vestradn);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.vestrafg);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.vestrafr);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.vestralo);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://vestrainternationaljaipur.com"));
        startActivity(i);
        break;
