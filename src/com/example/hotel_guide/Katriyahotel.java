...
public class Katriyahotel extends Four7 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.khtbad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.khtdinn);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.khtenterance);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.khtfr);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.khthall);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.katriyahotels & towers"));
        startActivity(i);
        break;
