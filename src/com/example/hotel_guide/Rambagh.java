...
public class Rambagh extends Five5 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.rambagh);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.rambaghbad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.rambaghfr);

		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.rambaghhall);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.rambaghoutside);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.rambaghpool);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.Rambaghpalacejaipur.com"));
        startActivity(i);
        break;
