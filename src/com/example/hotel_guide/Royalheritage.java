...
public class Royalheritage  extends Four5 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.rhhbad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.rhhbd);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.rhhdinn);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.rhhfr);
		break;
	...
	case R.id.tv:
        ...
        i.setData(Uri.parse("http://Royalaharitagehavelijaipur.com"));
        startActivity(i);
        break;
