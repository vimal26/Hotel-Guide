...
public class Vivantajodhpur extends Five10 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.vivfront);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.vivext);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.vivhall);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.vivpool);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.vivroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(" http://www.vivantabytajharimahel.com"));
        startActivity(i);
        break;
