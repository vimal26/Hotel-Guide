...
public class Papermint extends Four5 implements OnClickListener {
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.hldinnbad);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.hldinnfr);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.hldinnhall);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.hldinnpool);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.hldinnrf);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://peppermintjaipur.com"));
        startActivity(i);
        break;
