...
public class Ibispune extends Three3 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        startActivity(i);
    		setContentView(R.layout.ibispune);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.ibis);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.ibisbed);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.ibisdi);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.ibishall);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.ibisroom);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.ibispune.com"));
        startActivity(i);
        break;
