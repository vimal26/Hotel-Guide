...
public class Tajmahalpalace extends Five2 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.tajmahalpalace);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.tajmahalbe);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.tajmahalbed);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.tajmahaldi);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.tajmahalguest);
		break;
	case R.id.imageView5:
		im1.setImageResource(R.drawable.tajmahalhall);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.tajmahalpalace.com"));
        startActivity(i);
        break;
