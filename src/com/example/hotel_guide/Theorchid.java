...
public class Theorchid extends Five3 implements OnClickListener {
	ImageView im1,im2,im3,im4,im5,im6,im7,im8;
	Button txt;
	 protected void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.theorchid);
...
public void onClick(View arg0) {
	...
	case R.id.imageView1:
		im1.setImageResource(R.drawable.orchidbed);
		break;
	case R.id.imageView2:
		im1.setImageResource(R.drawable.orchidlift);
		break;
	case R.id.imageView3:
		im1.setImageResource(R.drawable.orchidpool);
		break;
	case R.id.imageView4:
		im1.setImageResource(R.drawable.orchidrest);
		break;
	case R.id.tv:
        Intent i= new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("http://www.theorchid.com"));
        startActivity(i);
        break;
